...
- Introduction to legal psychology and the legal system
- Wrongful convictions and the Innocence Project
- Eyewitness memory, lineup identifications, and witness interviewing
- False memories, recovered memories, and suggestibility
- Interrogations, confessions, and lie detection
- Cognitive bias in forensic science
- Developmental psychology and juvenile justice
- Prosecution, bail, pretrial detention, and plea bargaining
- Jury selection and jury decision-making
- Sentencing, incarceration, and the death penalty
- Corrections and problem-solving courts

## Teaching Approach

This course emphasizes active, applied learning. Students work with real cases, simulated legal problems, and role-based activities to practice applying psychological science to legal decision-making.

- **Case-Based Learning:** Students examine real and simulated legal cases to see how psychological principles operate in context. During the interrogation unit, for example, students analyze the Brendan Dassey interrogation from _Making a Murderer_, identifying Reid Technique themes such as loss of control, social isolation, certainty of guilt, and minimization. Students then connect those tactics to broader concerns about youth, vulnerability, comprehension, and false confession risk.

- **Role-Based Simulation:** Students take on legal-system roles to understand how decisions are shaped by evidence, uncertainty, and institutional constraints. In the voir dire unit, students act as jury consultants in a mock criminal case. They evaluate potential jurors, develop follow-up questions, recommend challenges for cause or peremptory challenges, and consider possible Batson issues.

- **Negotiation and Strategic Decision-Making:** Plea bargaining activities ask students to weigh evidence strength, defendant background, sentencing exposure, mitigation, and risk. Some simulations use short case files with prosecutor and defense roles. A more advanced juvenile plea negotiation asks students to identify a BATNA, reservation point, and likely zone of possible agreement before negotiating under time pressure.
